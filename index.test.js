...
it("calculator subs not numbers", () => {
...
it("calculator divide dividend is 0", () => {
  expect(test.calculator.divide(4, 0)).toBeCloseTo("error");
});
...
it("calculator multiply not numbers", () => {
